...
public class Virtualkey {
	  public static void main(String[] args) {
	    ...
	    public static void createWriteFile(){
			try {
			System.out.println("Enter how many files you want to create ? ");
			Scanner sc=new Scanner(System.in);
			int n=sc.nextInt();
			for(int i=0;i<n;i++) {
		    ...
		    System.out.println("Write anything in the current file : ");
		...
		public static void BusinessOperations() {
			String[] arr1 = {"1. Add a user specified file to the application",
               "2. Delete the file that are specified by the user",
               "3. Search the file specified by the user",
           ...
           // display the all the Strings mentioned in the String array
			...
			default:{
				System.out.println("Entered option is not there choose correct option \n"
